...
<div class="jumbotron text-center">
    <h1>${unObjectif.getLibobjectif()}</h1>
</div>
...
<div class="container">
    ...
    <div class="container">
        <h3>Liste des Actions de l'objectif ${unObjectif.getLibobjectif()}</h3>
        <table class="table table-hover">
            ...
            <c:forEach items="${unObjectif.getActions()}" var="item">
                <tr>
                    <td>${item.getNumaction()}</td>
                    <td>${item.getLibaction()}</td>
                </tr>
            </c:forEach>
        </table>
    </div>
